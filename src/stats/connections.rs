...
pub static TOTAL_CONNECTION_COUNTER: AtomicUsize = AtomicUsize::new(0);
...
pub static TLS_CONNECTION_COUNTER: AtomicUsize = AtomicUsize::new(0);
...
pub static PLAIN_CONNECTION_COUNTER: AtomicUsize = AtomicUsize::new(0);
...
pub static CANCEL_CONNECTION_COUNTER: AtomicUsize = AtomicUsize::new(0);
