...
`RESET INTERNER` чистит обе карты. Активные клиенты переparsят при
следующем использовании. Команда диагностическая.
