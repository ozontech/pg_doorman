...
- **Видимость prepared-кеша** — `SHOW INTERNER` и `SHOW POOLS_MEMORY` показывают объём interner'а и per-client разбивку Named / Anonymous, с парными gauge'ами в Prometheus.
