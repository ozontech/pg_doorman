...
Полный протокол, миграцию TLS и откат смотрите в [плавном обновлении бинаря](../tutorials/binary-upgrade.md).
...
- **В режиме демона или без TTY**: запускает обновление бинарника и плавное завершение работы, как `SIGUSR2`, для совместимости со старыми установками.
...
- [Плавное обновление бинаря](../tutorials/binary-upgrade.md) — полный протокол обновления с миграцией TLS.
