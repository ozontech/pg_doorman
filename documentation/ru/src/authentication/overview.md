...
| --- | --- | --- |
| [Сквозной режим](passthrough.md) (MD5 / SCRAM) | По умолчанию. Имя пользователя пула совпадает с пользователем PostgreSQL. | Хеш MD5 или SCRAM ClientKey, никогда — открытый пароль |
...
Подробности смотрите в [сквозном режиме](passthrough.md), а про выделенный режим — в [auth_query](auth-query.md).
...
- Новая инсталляция? Прочтите [сквозной режим](passthrough.md) и [базовое использование](../tutorials/basic-usage.md).
