...
Для ротации сертификатов с заменой процесса смотрите [горячую замену процесса с переносом сессий](../tutorials/binary-upgrade.md). TLS-сессии переносятся только в Linux-сборке с фичей `tls-migration`; без неё TLS-клиенты дренируются.
...
- Ротация сертификатов? Смотрите [горячую замену процесса с переносом сессий](../tutorials/binary-upgrade.md) и [Сигналы](../operations/signals.md). Для переноса TLS-сессий нужна Linux-сборка с `tls-migration`.
