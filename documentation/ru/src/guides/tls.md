...
Для ротации сертификатов без простоя смотрите [плавное обновление бинаря](../tutorials/binary-upgrade.md).
...
- Ротация сертификатов? Смотрите [плавное обновление бинаря](../tutorials/binary-upgrade.md) и [Сигналы](../operations/signals.md).
