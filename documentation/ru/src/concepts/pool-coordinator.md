...
Эта страница объясняет модель и сценарии применения. Рецепты настройки и разбор вывода `SHOW POOL_COORDINATOR` смотрите в [Пуле под нагрузкой](../tutorials/pool-pressure.md).
